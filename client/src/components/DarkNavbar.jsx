...
const DarkNavbar = () => {
  ...
  return (
    <nav className="bg-[#0D1216] sticky top-0 z-10 text-white font-semibold h-16 shadow-md border-none py-4 px-6 flex justify-between items-center">
      <div className="text-2xl">
        <Link href="/" className="">
          <Image
            className="rounded-full"
            src="/andishi-logo-whitebg.png"
      ...
      <div className="flex items-center space-x-16">
        <div className="flex items-center justify-center text-[16px] space-x-2">
          ...
          <div className="mx-8">
            <button
              ...
              className="flex items-center mx-8 text-white hover:text-[#21B1E6]"
            >
              About
              <IoIosArrowDown className="mx-1 mt-[2px]" />
            </button>
            {openDropdown === "about" && (
              <div className="absolute bg-[#0D1216] rounded-xl shadow-lg mt-2 py-2 w-40">
                <Link
                  href="/about"
          ...
          <div className="mx-8">
            ...
            {openDropdown === "more" && (
              <div className="absolute bg-[#0D1216] rounded-xl shadow-lg mt-2 py-2 w-48">
                <button
                ...
                {openSubDropdown === "knowledge-hub" && (
                  <div className="absolute left-full top-0 bg-[#0D1216] shadow-lg rounded-xl py-2 w-40">
                    <Link
        ...
        <div className="flex space-x-2">
          <Link
            href="/auth/login"
            className="flex items-center border secondary-text font-medium border-white hover:bg-[#21B1E6] hover:bg-opacity-25 transition text-white hover:border-blue-800 hover:text-gray-200 mx-2 px-6 py-[6px] rounded-full"
          >
